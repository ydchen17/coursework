...
```{r eval = FALSE}
# esc outputs
esc_B(meta_df.es.regression$Expt_Post_mean, meta_df.es.regression$Expt_Post_SD, 
      meta_df.es.regression$Expt_Post_N, meta_df.es.regression$Ctrl_Post_N, es.type = 'd')
esc_B(meta_df.es.regression$Expt_Post_mean, meta_df.es.regression$Expt_Post_SD, 
      meta_df.es.regression$Expt_Post_N, meta_df.es.regression$Ctrl_Post_N, es.type = 'g')
```
...
```{r eval = FALSE}
library(metafor)
meta_df.es.transformed <- escalc(m1i=Expt_Post_mean, sd1i=Expt_Post_SD, n1i=Expt_Post_N, 
                            m2i=Ctrl_Post_mean, sd2i=Ctrl_Post_SD, n2i=Ctrl_Post_N,
                            measure="SMD", vtype="UB", data=meta_df.es.raw, 
